...
CREATE TABLE IF NOT EXISTS admin_work (
  ...
  work_type ENUM('Administrative Operations', 'Compliance Management', 'Staff Oversight', 'Policy Implementation', 'Document Management', 'Document Upload', 'Project Creation', 'User Account Management', 'System Administration', 'Department Coordination') DEFAULT 'Administrative Operations',
  work_title VARCHAR(255) NOT NULL,
  work_description TEXT,
