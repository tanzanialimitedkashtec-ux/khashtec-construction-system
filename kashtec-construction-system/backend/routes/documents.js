    ...
    try {
        ...
        if (req.body.work_type && req.body.work_title) {
            ...
            const validWorkTypes = [
                ...
                'Project Creation', 'Safety Policy Upload', 'Toolbox Meeting', 'PPE Issuance', 'Safety Violation', 'User Account Management', 'System Administration', 'Department Coordination'
            ];
