...
router.put('/:id', async (req, res) => {
    try {
        ...
        await db.execute(`
            ...
            WHERE id = ?
        `, [
            resource_code != null ? resource_code : null,
            ...
            purchase_cost != null ? purchase_cost : null,
            ...
            expected_return_date != null ? expected_return_date : null,
            actual_return_date != null ? actual_return_date : null,
            return_condition != null ? return_condition : null,
            maintenance_notes != null ? maintenance_notes : null,
            req.params.id
        ]);
